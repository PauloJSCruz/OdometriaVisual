...
def LoadVideo():
    ...
    # VideoPath = "C:/Users/cruzs/OneDrive - Instituto Superior de Engenharia do Porto/1 - ISEP/3º Ano/2 Semestre/PESTA/1 - Recursos/VideoCorredor.mp4"
    # VideoPath = "C:/Users/cruzs/OneDrive - Instituto Superior de Engenharia do Porto/1 - ISEP/3º Ano/2 Semestre/PESTA/1 - Recursos/VideoVoltaCompleta.mp4"
    VideoPath = "C:/Users/cruzs/OneDrive - Instituto Superior de Engenharia do Porto/1 - ISEP/3º Ano/2 Semestre/PESTA/1 - Recursos/Robotica1080.mp4"
...
def DetectCorners(frameCanny):
    ...
    #region Detecta os pontos de interesse usando o FAST
    keypoints = fast.detect(frameCanny, None)
    # Converte os pontos de interesse para o formato aceito pelo algoritmo de fluxo óptico    
    cornersDetected = []
    cornersDetected = np.array([[kp.pt] for kp in keypoints], dtype=np.float32)
    # endregion
...
def DecomporMatrizEssencial(matrizEssencial, goodOldCorners, goodCorners):
    rotation1, rotation2, translation = cv2.decomposeEssentialMat(
        matrizEssencial, goodOldCorners, goodCorners)
    T2 = 0
    R1, R2, t = cv2.decomposeEssentialMat(matrizEssencial)
    ...
    # List of projections
    projections = [K @ Tl, K @ T2, K @ T3, K @ T4]
