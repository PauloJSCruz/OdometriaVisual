...
def main():
    ...
    save_kitti_format(camera_matrix, 'CalibrationCamFiles/ParameteresCamera.txt')
    ...
    np.savez('CalibrationCamFiles/calibrationDataPICamera', mtx=camera_matrix, dist=dist_coeffs, rvecs=rotation_vectors, tvecs=translation_vectors)
    undistort_image('FotosPICameraCalibration/image_0014.png', 'CalibrationCamFiles/calibrationDataPICamera.npz')
