...
images = glob.glob('FotosCalibracao/*.png')
i = 0
...
with open('cameramatrix.txt', 'w') as f:
        f.write(str(matrix)) 
with open('distortioncoefficient.txt', 'w') as f:
        f.write(str(distortion))
with open('rotationvectors.txt', 'w') as f:
        f.write(str(r_vecs)) 
with open('translationvectors.txt', 'w') as f:
        f.write(str(t_vecs))
