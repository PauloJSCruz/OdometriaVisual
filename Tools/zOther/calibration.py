...
# Leitura de imagens
imagesList = glob.glob('Tools/FotosCalibracao/*.png')  # Substitua pelo caminho correto para suas imagens
...
np.savez('Tools/calibration_data', mtx=cameraMatrix, dist=distCoeffs, rvecs=rotationVectors, tvecs=translationVectors)

# Função para desfazer distorção
def undistortImage(imagePath, saved_params='Tools/calibration_data.npz'):
...
undistortImage('Tools/FotosCalibracao/image_0022.png')  # Substitua pelo caminho correto para uma imagem de teste
